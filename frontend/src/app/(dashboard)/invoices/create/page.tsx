  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="flex items-center space-x-4">
        <Link href="/invoices" className="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-full transition-colors">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Créez une facture conforme avec calcul automatique des taxes.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-lg font-semibold text-slate-800 border-b border-slate-100 pb-3">Détails de la facturation</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-slate-700 mb-1">Client *</label>
                <select className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white placeholder-slate-400 placeholder-slate-400 text-slate-500"
                  value={clientId}
              ...
              <div>
                ...
                <input type="date" className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-slate-400 placeholder-slate-400 text-slate-500"
                  value={date}
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              {items.map((item, index) => (
                <div key={item.id} className="group relative flex flex-col md:grid md:grid-cols-12 gap-4 items-start md:items-center bg-slate-50 md:bg-transparent p-4 md:p-2 rounded-lg border border-slate-100 md:border-none">
                  ...
                  <div className="col-span-4 w-full">
                    ...
                    <input type="text" placeholder="Description de l'article ou service" className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm placeholder-slate-400 placeholder-slate-400 text-slate-500"
                  ...
                  <div className="col-span-2 w-full">
                    ...
                    <input type="number" min="1" className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-right placeholder-slate-400 placeholder-slate-400 text-slate-500"
                      value={item.quantity}
                  ...
                  <div className="col-span-2 w-full">
                    ...
                    <input type="number" min="0" step="0.01" className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-right placeholder-slate-400 placeholder-slate-400 text-slate-500"
                  ...
                  <div className="col-span-2 w-full">
                    ...
                    <select className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white md:text-right placeholder-slate-400 placeholder-slate-400 text-slate-500"
                      value={item.vatRate}
            ...
            <div className="mt-8 space-y-4">
              <div>
                <label className="flex text-sm font-medium text-slate-700 mb-1">Notes pour le client</label>
                <textarea 
                  rows={2}
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-center text-slate-500 mt-4">
              En finalisant, un numéro de facture officiel (FAC-YYYY-XXXX) sera attribué et la facture deviendra inaltérable.
            </p>
          </div>
        </div>
      </div>
